  ...
  <ActionBox>
    ...
    <template #rules>
      ...
      <p>
        ...
        <span class="ms-1 me-1" v-html="t('botAction.export-contract-fulfill.per')"></span>
      ...
      <p v-html="t('botAction.export-contract-fulfill.bonus')"></p>
      <p>
        <MoneyIcon :value="5"/>
        <span class="ms-1 me-1" v-html="t('botAction.export-contract-fulfill.per')"></span>
...
export default defineComponent({
  name: 'ActionExportContractFulfill',
  inheritAttrs: false,
  components: {
    AppIcon,
    MoneyIcon,
