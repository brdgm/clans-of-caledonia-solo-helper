      ...
      <tbody>
        ...
        <tr>
          ...
          <td v-for="index in playerCount" :key="index">
            <NumberInput v-model="amount.glory[index-1]"/>
          </td>
        ...
        <tr>
          ...
          <td v-for="index in playerCount" :key="index">
            <NumberInput v-model="amount.goodStandard[index-1]"/>
          </td>
          <td v-for="index in botCount" :key="index"></td>
        </tr>
        <tr>
          ...
          <td v-for="index in playerCount" :key="index">
            <NumberInput v-model="amount.goodProcessed[index-1]"/>
          </td>
          <td v-for="index in botCount" :key="index"></td>
        </tr>
        <tr>
          ...
          <td v-for="index in playerCount+botCount" :key="index">
            <NumberInput v-model="amount.money[index-1]"/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td v-for="index in playerCount+botCount" :key="index">
            <NumberInput v-model="amount.hops[index-1]"/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td v-for="index in playerCount+botCount" :key="index">
            <NumberInput v-model="amount.cotton[index-1]"/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td v-for="index in playerCount+botCount" :key="index">
            <NumberInput v-model="amount.tobacco[index-1]"/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td v-for="index in playerCount+botCount" :key="index">
            <NumberInput v-model="amount.sugarCane[index-1]"/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td v-for="index in playerCount+botCount" :key="index">
            <NumberInput v-model="amount.exportContract[index-1]"/>
          </td>
        </tr>
        <tr>
          <th scope="row">
          ...
          <td v-for="index in playerCount+botCount" :key="index">
            <NumberInput v-model="amount.settlement[index-1]"/>
          </td>
        </tr>
        ...
        <tr v-if="hasAwards">
          ...
          <td v-for="index in playerCount" :key="index">
            <NumberInput v-model="amount.awardVP[index-1]"/>
          </td>
          <td v-for="index in botCount" :key="index"></td>
        </tr>
        <tr v-if="hasTrainModule">
          ...
          <td v-for="index in playerCount" :key="index">
            <NumberInput v-model="amount.milestoneVP[index-1]"/>
          </td>
          <td v-for="index in botCount" :key="index"></td>
        </tr>
        <tr v-if="hasTrainModule">
          ...
          <td v-for="index in playerCount" :key="index">
            <NumberInput v-model="amount.trainDeliveryVP[index-1]"/>
          </td>
          <td v-for="index in botCount" :key="index"></td>
        </tr>
      </tbody>
